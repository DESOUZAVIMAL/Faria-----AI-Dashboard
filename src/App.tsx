        ...
        <div className="min-h-screen bg-[#391638] text-white selection:bg-[#E837AC]/20 selection:text-[#E837AC] font-sans antialiased relative overflow-hidden flex flex-col">
          ...
          <div className="flex-1 relative z-10">
            <Routes>
              ...
              {/* Dashboard loading TodayPage */}
              <Route path="/dashboard" element={<TodayPage />} />

              {/* Matrix view page */}
              <Route path="/matrix" element={<MatrixPage />} />

              {/* Fallback wildcard to prevent broken views */}
              <Route path="*" element={<Navigate to="/dashboard" replace />} />
            </Routes>
          </div>

          {/* Dynamic, human-centric footer matching Faria's voice */}
          <footer className="w-full py-6 mt-12 bg-[#391638] text-[#F0EBEB]/60 text-xs border-t border-[#37023c]/10 relative z-10">
